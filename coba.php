...
$freelances = mysqli_query($con, "SELECT * FROM freelance ORDER BY id_freelance ASC");
$nonaktif = mysqli_query($con, "SELECT * FROM freelance where end_date <= now()");
$minggu2 = mysqli_query($con, "SELECT * FROM freelance where end_date -14 < now()");
          ...
          <head>  
            ...
            {  
                 var data = google.visualization.arrayToDataTable([  
                           ...
                           {  
                                echo "['".$row["start_date"]."',".$row["end_date"].", ".$row["number"]."],";  
                           }  
                           ?>  
                      ]);  
                 var options = {  
