      ...
      <div class="container">
        <div class="row">
          <div class="title-section mb-5 col-12">
            <h2 class="text-uppercase">Hats Products</h2>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/TP2.png" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">CHAMPION PINK</a></h2>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/TP3.png" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">CHAMPION BLACK</a></h2>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            ...
            <h2 class="item-title"><a href="#">SMILE</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/TP5.png" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">LOVER NOT LOSER</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/TP6.png" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">T GREEN</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/TP7.png" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">T NAVY</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/TP8.png" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">VANS WHITE</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/TP9.png" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">VANS RED</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/TP10.png" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">NYC RED</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/TP11.png" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">NYC WHITE</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/TP12.png" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">NYC BLACK</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
