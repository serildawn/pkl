...
! function () {
    ...
    var c = (e.navigator || {}).userAgent,
        ...
        I = ["xs", "sm", "lg", "fw", "ul", "li", "border", "pull-left", "pull-right", "spin", "pulse", "rotate-90", "rotate-180", "rotate-270", "flip-horizontal", "flip-vertical", "flip-both", "stack", "stack-1x", "stack-2x", "inverse", "layers", "layers-text", "layers-counter"].concat(T.map(function (t) {
            return "".concat(t, "x")
    ...
    var D = g || {};
    D[p] || (D[p] = {}), D[p].styles || (D[p].styles = {}), D[p].hooks || (D[p].hooks = {}), D[p].shims || (D[p].shims = []);
    var q = D[p],
        W = [],
        X = !1;
    ...
    h && ((X = (v.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(v.readyState)) || v.addEventListener("DOMContentLoaded", function t() {
        v.removeEventListener("DOMContentLoaded", t), X = 1, W.map(function (t) {
            return t()
        })
    }));
    var G, J = "pending",
    ...
    var Pt = function () {},
        Lt = V.measurePerformance && f && f.mark && f.measure ? f : {
            mark: Pt,
            measure: Pt
        },
        _t = 'FA "5.8.2"',
    ...
    function Jt(t) {
        ...
        }, "").trim()), ">").concat(o.map(Jt).join(""), "</").concat(e, ">")
    }
    var Qt = function () {};
    ...
    function ee(n, t) {
        ...
        if (0 === n.length) a();
            ...
            var e = te;
            V.mutateApproach === z && (e = g.requestAnimationFrame || te), e(function () {
                var t = !0 === V.autoReplaceSvg ? $t.replace : $t[V.autoReplaceSvg] || $t.replace,
                    e = Rt.begin("mutate");
                n.map(t), e(), a()
            })
        }
    ...
    function ie(t) {
        if (l && V.observeMutations) {
            var r = t.treeCallback,
                ...
                n = void 0 === e ? v : e;
            re = new l(function (t) {
                ne || kt(t).forEach(function (t) {
                    if ("childList" === t.type && 0 < t.addedNodes.length && !Zt(t.addedNodes[0]) && (V.searchPseudoElements && o(t.target), r(t.target)), "attributes" === t.type && t.target.parentNode && V.searchPseudoElements && o(t.target.parentNode), "attributes" === t.type && Zt(t.target) && ~H.indexOf(t.attributeName))
    ...
    function oe(t) {
        var e, n, a = t.getAttribute("data-prefix"),
            ...
            o = Kt(At(t));
        return a && r && (o.prefix = a, o.iconName = r), o.prefix && 1 < i.length ? o.iconName = (e = o.prefix, n = t.innerText, (qt[e] || {})[n]) : o.prefix && 1 === i.length && (o.iconName = Bt(o.prefix, It(t.innerText))), o
    }
    var ce = function (t) {
        var e = {
            size: 16,
    ...
    function se(t) {
        var e, n, a, r, i, o, c, s = oe(t),
            ...
            p = (i = kt((r = t).attributes).reduce(function (t, e) {
                return "class" !== t.name && "style" !== t.name && (t[e.name] = e.value), t
            }, {}), o = r.getAttribute("title"), V.autoA11y && (o ? i["aria-labelledby"] = "".concat(V.replacementClass, "-title-").concat(xt()) : (i["aria-hidden"] = "true", i.focusable = "false")), i),
            g = (c = t.getAttribute("data-fa-mask")) ? Kt(c.split(" ").map(function (t) {
                return t.trim()
            })) : Vt();
        return {
            iconName: l,
    ...
    function be(t) {
        ...
        return ~a.extra.classes.indexOf(P) ? function (t, e) {
            ...
            return V.autoA11y && !n && (r.attributes["aria-hidden"] = "true"), gt.resolve([t, jt({
                content: t.innerHTML,
                width: i,
                height: o,
                transform: a,
    ...
    function ye(t) {
        ...
        if (h) {
            var e = v.documentElement.classList,
                ...
                o = [".".concat(P, ":not([").concat(U, "])")].concat(i.map(function (t) {
        ...
        return new gt(function (a, t) {
            ...
            if (r) {
                var o = n.getPropertyValue("content"),
                    c = ~["Light", "Regular", "Solid", "Brands"].indexOf(r[1]) ? j[r[1].toLowerCase()] : _[i],
                    s = It(3 === o.length ? o.substr(1, 1) : o),
                    l = Bt(c, s),
                    f = l;
                if (!l || e && e.getAttribute(C) === c && e.getAttribute(N) === f) a();
                else {
                    ...
                    var u = {
                        ...
                        d = u.extra;
                    d.attributes[w] = h, ge(l, c).then(function (t) {
                        var e = Et(B({}, u, {
                                icons: {
                                    main: t,
                                    mask: Vt()
    ...
    var je, Pe = new(function () {
        ...
        Te = (je = function (t) {
            ...
            var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
                n = (t || {}).icon ? t : Ee(t || {}),
                a = e.mask;
            return a && (a = (a || {}).icon ? a : Ee(a || {})), je(n, B({}, e, {
                mask: a
            }))
        }),
        Re = {
            noAuto: function () {
                V.autoReplaceSvg = !1, V.observeMutations = !1, re && re.disconnect()
            },
            config: V,
            dom: _e,
            library: Pe,
        ...
        He = function () {
            var t = (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).autoReplaceSvgRoot,
                e = void 0 === t ? v : t;
            (0 < Object.keys(q.styles).length || V.autoFetchSvg) && h && V.autoReplaceSvg && Re.dom.i2svg({
                node: e
            })
        };
    ! function (t) {
        ...
        u && (g.FontAwesome || (g.FontAwesome = Re), K(function () {
            He(), ie({
                treeCallback: ye,
                nodeCallback: we,
                pseudoElementsCallback: Ce
