      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 ml-auto order-md-2 align-self-start title-section mb-5 col-12 title-section text-center mb-5 col-12">
            ...
            <h1 class="site-navbar site-menu">MALE</h1>
            <h2>Aintrightco</h2>
      ...
      <div class="container">
        <div class="row">
          <div class="title-section mb-5 col-12">
            <h2 class="text-uppercase">T-Shirt Products</h2>
          </div>
        </div>
        <div class="row">
        <div class="col-lg-4 col-md-6 item-entry mb-4">
            ...
            <h2 class="item-title"><a href="#">KAMIKAZE</a></h2>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/M3.jpg" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">LONELY</a></h2>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            ...
            <h2 class="item-title"><a href="#">WAVE</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/M5.jpg" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">ISOMETRIC</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/M6.jpg" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">DOGO</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            ...
            <h2 class="item-title"><a href="#">HOPE</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/M8.jpg" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">SAD MAD BAD</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/M9.jpg" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">DON'T CRY</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/M10.jpg" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">LAZY GIRL</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/M12.jpg" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">MEGANE</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/M13.jpg" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">BLESSED</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/M14.jpg" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">HOPE</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/M15.jpg" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">OSAKA BURN</a></h2>
            <strong class="item-price">Rp. 130.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
