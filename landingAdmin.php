...
<br>
        ...
        <!-- <button type="logout" href="logout.php" class="fa fa-sign-out fa-fw">Logout</button> -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
										...
										<div class="form-group">
                                            <label for="exampleInputEmail1">Salary</label>
                                            <input type="text" name="salary" class="form-control" id="salary" placeholder="Masukkan Gaji Anda" required value="<?= $row["salary"] ?>">
                                        </div>
										<div class="form-group">
                                            <label for="exampleInputEmail1">Start Date</label>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" href= "landingAdmin.php" name="ed_freelance" class="btn btn-primary">Simpan</button>
