                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="p-t-10 icons">
                                        <a button class="btn btn--pill btn--green btn-primary" name="back" type="submit" href="edit.php ?id=<?php echo $row["id"]; ?>">
                                            <span class="icon-edit"></span>
                                            </button></a>
                                        <br><br>
                                        <a button class="btn btn--pill btn--green btn-danger" name="back" type="submit" href="../hapus.php ?id=<?php echo $row["id"]; ?>" onclick="return confirm('Apakah data ini akan dihapus')">
